          ...
          <GalleryItem>
            <Card>
              ...
              <CardBody>
                ...
                <Text component={TextVariants.p}>Quickly create business diagrams using a desktop application. Store files locally using the desktop
                  file system.
                  </Text>
            ...
            <Card>
              ...
              <CardBody>
                <TextContent className="pf-u-mb-xl">
                <Text component={TextVariants.p}>Easily access online tooling and storage. The web experience offers direct access to online business process and decision editors.
                  </Text>
                  <Text component="p"> </Text>
                </TextContent>
                <List>
                  <ListItem>
                    Online access to projects and editors
                  </ListItem>
                  <ListItem>
            ...
            <Card>
              ...
              <CardBody>
                <TextContent className="pf-u-mb-xl">
                <Text component={TextVariants.p}>Online direct access to editors in the preferred developer source code host
                  </Text>
                  <Text component="p"> </Text>
                </TextContent>
                <List>
                  ...
                  <ListItem>
                    Integrate diretly into source code host (GitHub)
                  </ListItem>
                </List>
              </CardBody>
              <CardFooter>
            ...
            <Card>
              ...
              <CardBody>
                <TextContent className="pf-u-mb-xl">
                <Text component={TextVariants.p}>Integrate directly with developer IDEs. Edit files directly in a developer IDE environment.
                  </Text>
                  <Text component="p"> </Text>
                </TextContent>
                <List>
                  ...
                  <ListItem>
                    Integrate directly into developer IDE
                  </ListItem>
                </List>
              </CardBody>
              <CardFooter>
